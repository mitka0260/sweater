<#macro login path isRegisterForm>
    ...
    <form action="${path}" method="post">
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" name="username" value="<#if user??>${user.username}</#if>" class="form-control ${(usernameError??)?string('is-invalid', '')}" placeholder="User name" autofocus="autofocus" />
                <#if usernameError??>
        ...
        <#if isRegisterForm>
            ...
            <div class="col-sm-6">
                <div class="g-recaptcha" data-sitekey="6LfW42gaAAAAABytOQXkVbW7kF6UAfuuRNLwh_Cs"></div>
                <#if captchaError??>
